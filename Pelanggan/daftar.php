...
if (isset($_REQUEST['nama_penuh'])){
    ...
    $query = "INSERT into `daftar_pelanggan` (nama_penuh, alamat_emel, nombor_telefon, nama_pengguna, kata_laluan)
    ...
    echo '<script>window.location.href= "logmasuk.php";</script>';
