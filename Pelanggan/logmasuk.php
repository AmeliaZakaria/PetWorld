...
if (isset($_POST['nama_pengguna'])){
	...
	//Checking is user existing in the database or not
        $query = "SELECT * FROM `daftar_pelanggan` WHERE nama_pengguna='$nama_pengguna'
...
<br/>Klik di sini untuk <a href='logmasuk.php'>Log Masuk</a></div>";
	}
    }else{
?>
<h2>LOG MASUK</h2>
...
<br><br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Belum Mendaftar? <a href='daftar.php'>Daftar Di Sini</a></p>
</div>
<?php } ?>
        </section>
