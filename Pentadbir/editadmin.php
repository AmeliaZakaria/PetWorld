...
?>
    <form action="editadmin.php" method="post" name="edit" enctype="multipart/form-data" >
...
<input type="hidden" name="idPentadbir" value="<?php echo $row[0]; ?>"  /><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
{
    echo '<script>window.location.href= "profiladmin.php";</script>';
} 
    if(isset($_POST['update']))
    {
        $idPentadbir = $_POST['idPentadbir'];

        $query = " SELECT * FROM daftar_pentadbir WHERE idPentadbir = '$idPentadbir' ";
    ...
    if(isset($_POST['new_nama_penuh']))
    {
        ...
        $query = "UPDATE daftar_pentadbir SET nama_penuh='$new_nama_penuh', alamat_emel='$new_alamat_emel', nombor_telefon='$new_nombor_telefon', nama_pengguna='$new_nama_pengguna'
                    WHERE idPentadbir = '$idPentadbir'";
